...
class TestCaseRun {
    ...
    fillExecutedHooks(hookType) {
        return new TestCaseRunHooks_1.TestCaseRunHooks(this, hookType, this.bgSteps).fill();
    }
    ...
    getPossiblePwSteps() {
        ...
        return (0, pwStepUtils_1.findAllStepsWithCategory)(this.result, 'test.step');
    }
}
